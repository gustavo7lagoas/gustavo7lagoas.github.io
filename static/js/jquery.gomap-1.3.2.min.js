...
jQuery(document).ready(function() {
	// initiate googlemaps
    jQuery('#map').goMap({ address: '440 Rodovia Admar Gonzaga, Florianópolis',
	    	zoom: 14,
	    	navigationControl: true,
	    	maptype: 'ROADMAP',
	    	draggable: false, zoomControl: false, scrollwheel: false, disableDragging: true,
	    	markers: [
	    		{ 'address' : '440 Rodovia Admar Gonzaga, Florianópolis' }
	    	],
        addMarker: true,
...
var styles = [ { "stylers": [ { "visibility": "on" }, { "saturation": -100 }, { "gamma": 1 } ] },{ } ];
    ...
    mapTypeControlOptions: {
       mapTypeIds: [google.maps.MapTypeId.ROADMAP, 'starcEngenharia']
    }});

    var styledMapOptions = {
        name: "starcEngenharia"
    }

    var jayzMapType = new google.maps.StyledMapType(
        styles, styledMapOptions);

    $.goMap.map.mapTypes.set('starcEngenharia', jayzMapType);
    $.goMap.map.setMapTypeId('starcEngenharia');
